...
<?php tpl_flush() ?>
<body class="<?php echo $TPL->getClasses() ?>" data-page-id="<?php echo $ID ?>" data-user="<?php echo htmlspecialchars($_SERVER['REMOTE_USER'] ?? ''); ?>"><div class="dokuwiki"><?php /* CSS class for Plugins and user styles */ ?>
